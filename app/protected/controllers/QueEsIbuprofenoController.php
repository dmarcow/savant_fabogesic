...
class QueEsIbuprofenoController extends Controller
{
	/**
	...
	{
		$model=new QueEsIbuprofeno;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['QueEsIbuprofeno']))
		{
	...
	{
		$dataProvider=new CActiveDataProvider('QueEsIbuprofeno');
	...
	{
		$model=new QueEsIbuprofeno('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['QueEsIbuprofeno']))
			$model->attributes=$_GET['QueEsIbuprofeno'];
	 ...
	 * @return QueEsIbuprofeno the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=QueEsIbuprofeno::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param QueEsIbuprofeno $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='que-es-ibuprofeno-form')
		{
