...
class PresentacionesSub4Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PresentacionesSub4']))
		{
			$model->attributes=$_POST['PresentacionesSub4'];
	...
	{
		$dataProvider=new CActiveDataProvider('PresentacionesSub4');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['PresentacionesSub4']))
			$model->attributes=$_GET['PresentacionesSub4'];
	...
	{
		$model=PresentacionesSub4::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PresentacionesSub4 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='presentaciones-sub4-form')
		{
