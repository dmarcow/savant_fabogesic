...
class PresentacionesSub1Controller extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('PresentacionesSub1');
	...
	{
		$model=new PresentacionesSub1('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PresentacionesSub1']))
			$model->attributes=$_GET['PresentacionesSub1'];
	 ...
	 * @return PresentacionesSub1 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=PresentacionesSub1::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PresentacionesSub1 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='presentaciones-sub1-form')
		{
