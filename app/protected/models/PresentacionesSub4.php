...
/**
 * This is the model class for table "PresentacionesSub4".
 *
 * The followings are the available columns in table 'PresentacionesSub4':
 * @property integer $id
 ...
 */
class PresentacionesSub4 extends CActiveRecord
{
	 ...
	 * @return PresentacionesSub4 the static model class
	 */
